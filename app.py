...
# Streamlit watchdog의 "Paths don't have the same drive" 에러 방지용 코드
if "STREAMLIT_TEMP_SET" not in os.environ:
    try:
    ...
    os.environ["STREAMLIT_TEMP_SET"] = "1" # 최초 1회만 실행되도록 하는 플래그
